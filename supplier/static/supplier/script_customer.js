...
// ====================================================================================== //
		...
		$('#customer_rfq').on('focusout', function(){
...
// ======================================================================================
			...
			$('#customer_quotation').on('focusout', function(){
				...
				req =	$.ajax({
				 ...
				 .done(function done(data){
					 row = JSON.parse(data.row)
					 $('#quotation_customer_attn').val(row[0].fields['attn'])
					 $('#quotation_customer_prcbasis').val(row[0].fields['prc_basis'])
					 $('#quotation_customer_leadtime').val(row[0].fields['lead_time'])
					 $('#quotation_customer_validity').val(row[0].fields['validity'])
					 $('#quotation_customer_payment').val(row[0].fields['payment'])
					 $('#quotation_customer_currency').val(row[0].fields['currency'])
					 $('#quotation_customer_exchange_rate').val(row[0].fields['exchange_rate'])
				 });
			})
...
// // Append table with add row in po supplier
			...
			$('#po_customer').on('focusout', function(){
				...
				req =	$.ajax({
				 ...
				 .done(function done(data){
					 row = JSON.parse(data.row)
					 $('#po_customer_attn').val(row[0].fields['attn'])
					 $('#po_customer_prcbasis').val(row[0].fields['prc_basis'])
					 $('#po_customer_leadtime').val(row[0].fields['lead_time'])
					 $('#po_customer_validity').val(row[0].fields['validity'])
					 $('#po_customer_payment').val(row[0].fields['payment'])
					 $('#po_customer_currency').val(row[0].fields['currency'])
					 $('#po_customer_exchange_rate').val(row[0].fields['exchange_rate'])
				 });
			})
